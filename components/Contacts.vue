  ...
  <div>
    <header class="pt-10 text-center">
      ...
      <p class="text-gray-400 mt-2">
        I'd love to hear about your project or collaboration.
      </p>
    </header>

    <main
      class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-8 mt-10 items-start"
    >
      <!-- Contact Info Card -->
      <aside
        data-aos="fade-up-right"
        class="relative rounded-2xl p-6 bg-gradient-to-br from-[#10131a] to-[#1b2130] shadow-xl border border-gray-800"
      >
        <div class="-mt-6 mb-4">
          ...
          <p class="text-sm text-gray-400">
            Reach out for collaborations, freelance work, or a friendly hello.
          </p>
        </div>
          ...
          <div class="flex items-start gap-3">
            ...
            <div>
              <a
                ...
                >+254 792 857 288</a
              >
              <a href="tel:+254759732432" class="block text-sm text-gray-400"
                >+254 759 732 432</a
              >
            </div>
          </div>
      ...
      <section
        ...
        class="p-6 rounded-2xl bg-[#0b0d12] border border-gray-800 shadow-lg"
      >
        <form @submit.prevent="send" class="space-y-4">
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                v-model="form.name"
                required
                class="mt-1 block w-full p-3 rounded-lg bg-transparent border border-gray-700 text-gray-200 placeholder-gray-500 focus:ring-2 focus:ring-[#ff4b57] focus:border-transparent outline-none"
          ...
          <div>
            <label for="subject" class="block text-sm text-gray-300"
              >Subject</label
            >
            <input
              id="subject"
          ...
          >
            ...
            <div>
              <Button
                :disabled="loading"
                class="bg-[#ff4b57] hover:bg-[#ff6b77] w-full min-h-[44px] py-3 text-base"
