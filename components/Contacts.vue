<template>
  <div>
    ...
    <main
      class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 mt-10 items-center"
    >
      <div
        data-aos="fade-up-right"
        data-aos-anchor-placement="top-center"
        class="bg-[#ff4b57] p-6 rounded-lg dark:text-gray-300 h-80"
      >
      ...
      >
        <form @submit.prevent="send">
          ...
          <div class="mb-4 w-full pt-4">
            <label
              for="message"
              class="block text-sm font-medium text-[#ff4b57]"
              >Message</label
            >
            <textarea
              id="message"
          ...
          <div class="mt-6">
            <Button :disabled="loading" class="bg-[#ff4b57] cursor-pointer">{{
